  ...
  return (
    <section className={styles.Description}>
      ...
      <div className={styles.Description__text}>
        <h2>Manage your finances easily and safely</h2>
        <p>CWith just a few clicks, you can access all the information about your payments, allowing you to have complete and up-to-date control of your transactions. Our mission is to give you the confidence and peace of mind you deserve when managing your finances, all in a secure and accessible environment. Start exploring and discover the convenience of having your payments always within reach!.</p>
      </div>
    </section>
  )
}